...
declare class Controller implements IController {
     ...
     * @protected
     */
    static instanceMap: Map<string, IController>;
    /**
...
declare class Model implements IModel {
     ...
     * @protected
     */
    static instanceMap: Map<string, IModel>;
    /**
...
declare class View implements IView {
     ...
     * @protected
     */
    protected static instanceMap: Map<string, IView>;
    /**
...
declare class Notification implements INotification {
     ...
     */
    constructor(name: string, body?: unknown, type?: string);
    /**
     * Get the name of the <code>Notification</code> instance.
     *
     * @return
 ...
 * such as a subclass of <code>Notification</code>.
 */
declare class Observer<ContextType = any> implements IObserver {
    #private;
    /**
     ...
     */
    constructor(notifyMethod: Function, notifyContext: ContextType);
    /**
     ...
     * 		The object and the notification context are the same.
     */
    compareNotifyContext(object: ContextType): boolean;
}
...
declare class MacroCommand extends Notifier implements ICommand, INotifier {
     ...
     * @protected
     */
    addSubCommand(commandClass: CommandConstructor): void;
    /**
...
declare class Facade implements IFacade {
     ...
     * @protected
     */
    static instanceMap: Map<string, IFacade>;
    /**
 ...
 */
declare class Mediator<ViewComponentType> extends Notifier implements IMediator, INotifier {
    #private;
    /**
     ...
     */
    getViewComponent(): ViewComponentType | undefined;
    /**
     * Set the <code>IMediator</code>'s view component.
     *
     * @param viewComponent
     * 		The default view component to set for this <code>Mediator</code>.
     */
    setViewComponent(viewComponent?: ViewComponentType): void;
    /**
     * List the <code>INotification</code> names this <code>IMediator</code> is interested in
     * being notified of.
     *
 ...
 * data.
 */
declare class Proxy<DataType> extends Notifier implements IProxy<DataType>, INotifier {
    #private;
    /**
